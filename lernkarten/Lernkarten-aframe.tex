...
\par
Eine Farbe wird hierzu aus drei Helligkeitswerten für rot, grün und blau zusammengemischt. Diese Art der Farbdarstellung bezeichnet man als {\bfseries RGB-Kodierung}. Jeder der drei Farbkanäle kann Werte zwischen 0 und $(255)_{10}=(FF)_{16}$ annehmen. Die Werte werden im Anschluss an ein Doppelkreuz direkt hintereinander geschrieben, je Kanal zwei Hexadezimalziffern.
\begin{itemize}
